...
export default function CreatorsDashboard({ creators }: { creators: Creator[] }) {
  ...
  return (
    <div style={{ padding: "32px 32px 80px", maxWidth: 960, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28, gap: 16, flexWrap: "wrap" }}>
        <div>
          ...
          <div style={{ fontFamily: "var(--font-tagline)", fontSize: 13, fontStyle: "italic", color: "var(--text-muted)" }}>
            Manage affiliate creator codes and their discount rates
          </div>
        </div>
        <button
          onClick={openAdd}
      ...
      {creators.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {/* Table header */}
          <div style={{
            display: "grid", gridTemplateColumns: "2fr 1.2fr 80px 80px 100px 120px",
        ...
        >
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                <label style={{ fontFamily: "var(--font-body)", fontSize: 11, fontWeight: 700, color: "var(--text-muted)", letterSpacing: "0.1em", textTransform: "uppercase", display: "block", marginBottom: 6 }}>
                  YouTube Channel ID <span style={{ fontWeight: 400, textTransform: "none", letterSpacing: 0 }}>(optional — used to boost their videos in study flow)</span>
                </label>
                <input
                  style={inp}
